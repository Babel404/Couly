	 ...
	 */
	 ...
	 HttpServletResponse response) throws ServletException, IOException {
		...
		try {
			...
			if (key != null) {
				ArrayList<Integer> friends = ServiceTools.getFriends(key);
				for (Integer friend_id : friends) {
					
						String log = ServiceTools.getLoginFromId(friend_id);
				...
				ArrayList<Integer> friends = ServiceTools.getFriends(ServiceTools.getIdUser(user));
				for (Integer friend_id : friends) {
